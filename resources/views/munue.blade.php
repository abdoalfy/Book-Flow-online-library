      ...
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center">
          ...
          <div class="col-md-7 col-sm-12 text-center ftco-animate">
              <h1 class="mb-3 mt-5 bread">All Books</h1>
              <p class="breadcrumbs"><span class="mr-2"><a href="index.html">Home</a></span> <span>Shelf</span></p>
          </div>
  ...
  <section class="ftco-menu mb-5 pb-5">
      <div class="container">
        ...
        <div class="col-md-7 heading-section text-center ftco-animate">
          ...
          <h2 style="color:#6d4400" class="mb-4">All Books</h2>
                  ...
                  <div class="tab-content ftco-animate" id="v-pills-tabContent">
                    ...
                    <div class="tab-pane fade show active" id="v-pills-2" role="tabpanel" aria-labelledby="v-pills-2-tab">
                      <div class="row">
                        ...
                        <?php
                        $descriptions=substr($book->description,0,350);
                        ?>
                          <div class="col-md-3 text-center">
                                <div class="menu-wrap">
                                    <a href="#" class="menu-img img mb-4" style="background-image: url({{ asset('assets/images/'.$book->image.'')}});"></a>
                                    <div class="text">
                                        <h3><a href="{{ route('details', $book->id)}}">{{ $book->name }}</a></h3>
                                        <p class="text-center">{{  $descriptions }}.</p>
                                        <p><a href="{{ route('details', $book->id)}}" class="btn btn-primary btn-outline-primary">Show details</a></p>
                                    </div>
                                </div>
                            </div>
                            @endforeach
